...
namespace TestConsole
{
    public class Npcs
    {
        ...
        string[,] itemReact = //holds placeholders for the reaction to being shown an item
        {
            ...
            {"Envy: (They take the SERVANT'S NOTE) Hey! What's with that look, hah? Its not as though others haven’t done this in the past. Us Servants have an honor code, back off, Mx Detective.","Envy: Ah? The SERVANT CALENDER? So *what*? Just cause I wasn’t supposed to be working the day he was murdered doesn’t mean anything! Its not like I had anything to do. Its not like I went to the town or anything, whats got you so pressed?", "Envy: Gimme that! That's my DIARY! Personal thoughts and all! Not like some 2-bit detective like you would understand, looking into it and all.", "Envy: Hmph. Thats not mine. I don’t have enough money to even get something like that. Now get outta here."},
