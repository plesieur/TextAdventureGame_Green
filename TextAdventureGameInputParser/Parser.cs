...
namespace TextAdventureGameInputParser
{
    public class Parser
    {
        ...
        public Sentence Parse(string input)
        {
            ...
            result.ParseSuccess = result.Word1 != null
                && string.IsNullOrWhiteSpace(result.UnknownWord);
        ...
        public void PrintVerbs(int x)
        {
            //changed how verbs are printed. must insert a "num" of verbs to print out.
            for (int i = 0; i < x; i++) {
